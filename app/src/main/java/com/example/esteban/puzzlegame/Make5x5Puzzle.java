 ...
 * @since 2016-10-13
 */
public class Make5x5Puzzle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_make5x5_puzzle);
        ...
        for (int i = 0; i < buttons.length; i++) {
            for (int j = 0; j < buttons[i].length; j++) {
                ...
                gridLayout.addView(buttons[i][j], 100, 150);//add buttons to the gridLayout
