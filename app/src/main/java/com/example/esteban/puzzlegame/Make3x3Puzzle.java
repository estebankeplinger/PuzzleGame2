 ...
 * @since 2016-10-13
 */
public class Make3x3Puzzle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_make3x3_puzzle);
        ...
        for (int i = 0; i < buttons.length; i++) {
            for (int j = 0; j < buttons[i].length; j++) {
                ...
                gridLayout.addView(buttons[i][j], 330, 300);//add buttons to the gridLayout
